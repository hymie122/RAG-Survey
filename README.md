...
- [guardian-agent-prompts](https://github.com/milkomida77/guardian-agent-prompts) - 49 production-tested AI agent system prompts with knowledge graph memory integration for multi-agent orchestration. MIT licensed.
# Overview
